...
class DETRLoss(nn.Module):
    ...
    def __init__(self,
        ...
        if self.use_wiseiou:
            self.wiou_loss = WiseIouLoss(ltype='WIoU', monotonous=None, inner_iou=False, focaler_iou=False)
    ...
    def _get_loss_bbox(self, pred_bboxes, gt_bboxes, postfix=''):
        ...
        if self.use_wiseiou:
            ...
            #loss[name_giou] = 1.0 - bbox_inner_iou(pred_bboxes, gt_bboxes, xywh=True, SIoU=True, ratio=0.7) # Inner IoU
